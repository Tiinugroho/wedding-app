...
<body class="bg-slate-50 text-slate-800 font-sans overflow-x-hidden relative">
    ...
    <main>
            ...
            <div class="max-w-7xl mx-auto px-4 z-10">
                <div class="flex flex-col lg:flex-row items-center gap-12">
                    <div class="lg:w-1/2 text-center lg:text-left reveal">
                        <span class="inline-block py-1.5 px-4 rounded-full bg-white border border-rLightOrange/30 text-rOrange text-sm font-bold mb-6 shadow-sm">
                        ...
                        <p class="mt-4 max-w-2xl text-lg text-slate-500 mb-10 leading-relaxed font-medium">
                        ...
                        <div class="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                            <a href="{{ route('register') }}" class="bg-gradient-to-r from-rRed to-rOrange text-white px-8 py-4 rounded-full font-bold text-lg glow-btn text-center hover:-translate-y-1 transition-transform">
                                Buat Undangan Sekarang
                            </a>
                            <a href="#produk" class="bg-white text-slate-700 border border-slate-200 px-8 py-4 rounded-full font-bold text-lg hover:bg-slate-50 transition text-center flex items-center justify-center gap-2">
                                Lihat Katalog
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="lg:w-1/2 relative flex justify-center items-center reveal" style="transition-delay: 200ms;">
                        <div class="relative z-20 w-[280px] h-[580px] bg-slate-900 rounded-[3rem] border-[8px] border-slate-800 shadow-2xl overflow-hidden">
                            ...
                            <div class="w-full h-full bg-white bg-[url('https://images.unsplash.com/photo-1607190074257-dd4b7af0309f?q=80&w=1887&auto=format&fit=crop')] bg-cover bg-center">
                                ...
                                <div class="absolute bottom-10 left-0 w-full text-center text-white px-4">
                                    <p class="text-xs uppercase tracking-widest mb-1">The Wedding Of</p>
                                    <h2 class="text-3xl font-serif mb-2">Jati & Nabila</h2>
                                    <p class="text-sm border border-white/30 inline-block px-4 py-1.5 rounded-full backdrop-blur-md">14 . 02 . 2026</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="absolute -right-4 top-20 glass-light p-4 rounded-2xl shadow-xl z-30 hidden md:block animate-bounce" style="animation-duration: 4s;">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Konfirmasi Hadir</p>
                                    <p class="text-xs font-bold text-slate-800">Keluarga Bpk. Fulan</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="absolute -left-10 bottom-32 glass-light p-4 rounded-2xl shadow-xl z-30 hidden md:block animate-bounce" style="animation-duration: 5s;">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Kado Digital</p>
                                    <p class="text-xs font-bold text-slate-800">Dana Berhasil Masuk</p>
                                </div>
                            </div>
                        </div>
        ...
        <section id="cara-kerja" class="py-24 bg-white relative border-t border-slate-100">
            <div class="max-w-7xl mx-auto px-4 reveal">
                <div class="text-center mb-16">
                    <h2 class="text-3xl md:text-4xl font-extrabold text-slate-800">Sangat Mudah, <span class="text-rOrange">Cukup 3 Langkah</span></h2>
                    <p class="text-slate-500 mt-3 font-medium">Tidak perlu jago coding atau desain. Semua sudah otomatis!</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center relative">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-slate-500 text-sm">Undangan digitalmu sudah aktif! Langsung salin link-nya dan bagikan ke WhatsApp teman serta kerabatmu.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="feature" class="py-24 relative bg-slate-50 border-t border-slate-100">
            <div class="max-w-7xl mx-auto px-4 reveal">
                <div class="text-center mb-16">
                    <h2 class="text-3xl md:text-4xl font-extrabold text-slate-800">Fitur <span class="text-rOrange">Lengkap & Premium</span></h2>
                    <p class="text-slate-500 mt-3 font-medium">Fasilitas undangan modern untuk memanjakan tamu dan mempermudah kamu.</p>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-white p-8 rounded-[2rem] hover:-translate-y-2 transition-all duration-300 group hover:shadow-2xl border border-slate-100">
                        ...
                        <h3 class="text-lg font-extrabold text-slate-800 mb-2">Masa Aktif 1 Bulan</h3>
                        <p class="text-slate-500 text-sm leading-relaxed">Undanganmu akan online tanpa henti siang dan malam, bisa diakses kapan saja oleh tamu undangan.</p>
                    </div>
                    ...
                    <div class="bg-white p-8 rounded-[2rem] hover:-translate-y-2 transition-all duration-300 group hover:shadow-2xl border border-slate-100">
                        ...
                        <h3 class="text-lg font-extrabold text-slate-800 mb-2">Buku Tamu (RSVP)</h3>
                        <p class="text-slate-500 text-sm leading-relaxed">Dapatkan kepastian jumlah tamu yang hadir dan terima ucapan doa indah langsung di layar undanganmu.</p>
                    </div>
                    ...
                    <div class="bg-white p-8 rounded-[2rem] hover:-translate-y-2 transition-all duration-300 group hover:shadow-2xl border border-slate-100">
                        ...
                        <h3 class="text-lg font-extrabold text-slate-800 mb-2">Sistem QR Code</h3>
                        <p class="text-slate-500 text-sm leading-relaxed">Selamat tinggal buku tamu kertas! Scan QR Code tamu di lokasi acara untuk proses check-in yang canggih.</p>
                    </div>
                    ...
                    <div class="bg-white p-8 rounded-[2rem] hover:-translate-y-2 transition-all duration-300 group hover:shadow-2xl border border-slate-100">
                        ...
                        <h3 class="text-lg font-extrabold text-slate-800 mb-2">Amplop Digital</h3>
                        <p class="text-slate-500 text-sm leading-relaxed">Tamu yang berhalangan hadir dapat mengirimkan hadiah atau angpao langsung ke rekening Bank/E-Wallet kamu.</p>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                @if (is_array($includedItems) && count($includedItems) > 0)
                                    @foreach ($includedItems as $included_feature)
                                        <li class="flex items-start text-slate-700 font-semibold">
                                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg>
                                ...
                                @if (is_array($excludedItems) && count($excludedItems) > 0)
                                    @foreach ($excludedItems as $excluded_feature)
                                        <li class="flex items-start text-slate-400 font-medium">
                                            <svg class="w-5 h-5 text-slate-300 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M6 18L18 6M6 6l12 12"></path></svg>
    ...
    <footer class="bg-white border-t border-slate-100 pt-16 pb-8">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex flex-wrap justify-center gap-6 text-slate-500 font-bold text-sm">
                    <a href="#home" class="hover:text-rOrange transition">Beranda</a>
                    <a href="#produk" class="hover:text-rOrange transition">Katalog</a>
                    <a href="javascript:void(0)" onclick="alert('Syarat & Ketentuan')" class="hover:text-rOrange transition">Syarat</a>
                    <a href="javascript:void(0)" onclick="alert('Kebijakan Privasi')" class="hover:text-rOrange transition">Privasi</a>
                </div>
            </div>
