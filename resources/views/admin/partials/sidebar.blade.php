...
<aside id="admin-sidebar"
    ...
    <nav class="flex-1 space-y-1.5 overflow-y-auto pr-2 custom-scrollbar pb-10">
        ...
        <a href="{{ route('admin.settings.index') }}"
            class="nav-item flex items-center gap-4 px-5 py-3.5 rounded-2xl transition group {{ request()->routeIs('admin.settings.*') ? 'active' : 'text-slate-400 font-semibold hover:bg-slate-100 hover:text-slate-600' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
