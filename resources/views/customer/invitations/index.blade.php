    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
        ...
        @forelse($invitations as $invitation)
            ...
            <div class="invitation-card bg-white rounded-[3rem] overflow-hidden border border-slate-100 shadow-sm flex flex-col h-full {{ $invitation->status == 'draft' ? 'opacity-80 grayscale hover:grayscale-0 hover:opacity-100' : '' }}">
                ...
                <div class="h-56 bg-slate-200 relative overflow-hidden group">
                    <img src="{{ asset('storage/' . ($invitation->template->thumbnail ?? 'default.jpg')) }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-700" alt="Tema">
                    ...
                    <div class="absolute bottom-6 left-6 right-6 flex justify-between items-end">
                        ...
                        <div class="text-white text-right">
                            <p class="text-[10px] font-bold opacity-70 uppercase">Link</p>
