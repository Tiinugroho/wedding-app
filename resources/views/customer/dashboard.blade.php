        ...
        <div
            ...
            <div class="relative z-10">
                ...
                <div class="flex items-end gap-3">
                    <span
                        class="text-3xl md:text-4xl font-extrabold text-slate-800">{{ number_format($totalInvitations) }}</span>
            ...
            @foreach ($invitations as $invitation)
                @php
                    ...
                    if ($invitation->status != 'active') {
                        ...
                        // 2. LOGIKA UNTUK SUDAH LUNAS (Masa Aktif Premium, berakhir pukul 23:59:59)
                        if ($invitation->expires_at) {
                            $batasWaktuAktif = \Carbon\Carbon::parse($invitation->expires_at)->endOfDay();
                            $tanggalBerakhir = $batasWaktuAktif->format('d M Y'); // Format tanggal premium
                            ...
                            $tanggalBerakhir = 'Tidak Terbatas'; // Jaga-jaga jika null
                        }
                    }
                @endphp
                ...
                <div
                    ...
                    <div>
                        ...
                        {{-- 🔥 BAGIAN TANGGAL DIBUAT & BERAKHIR 🔥 --}}
