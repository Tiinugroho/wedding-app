                ...
                <li class="dropdown pc-h-item header-user-profile">
                    <a class="pc-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" data-bs-auto-close="outside" aria-expanded="false">
                        ...
                        @php
                            ...
                            if ($userAvatar) {
                                // Jika login dari Google (URL), langsung gunakan. Jika upload lokal, arahkan ke folder storage.
                                $avatarUrl = filter_var($userAvatar, FILTER_VALIDATE_URL) ? $userAvatar : asset('storage/' . $userAvatar);
                            } else {
                                // Gunakan default image dari template jika belum punya avatar
